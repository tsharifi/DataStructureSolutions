...
implements BinarySearchTreeADT<T>
{
	...
	public T removeMax() throws EmptyCollectionException 
	{
		...
		// Methods copied and modified from removeMin method
	...
	public LinkedBinarySearchTree<T> getLeft()
	{
		...
		if(isEmpty())
		{
			throw new EmptyCollectionException("Left Element"); 
		}
		LinkedBinarySearchTree<T> temp = new LinkedBinarySearchTree<T>(); 
	...
	public void bruteForce()
	{
		...
		root = null; 
		bruteForce(tempList, 0, tempList.size() - 1); 
	}
	

	private void bruteForce (ArrayUnorderedList<T> tempList, int minimum, int maximum) {
		
		int middle = (minimum + maximum) / 2; 
		while(tempList.list[middle] != null) {
			
			addElement(tempList.list[middle]); 
			tempList.list[middle] = null;
			if(middle <= maximum) {
				bruteForce (tempList, middle + 1, maximum );
			}
			if(middle - 1 >= minimum) {
				bruteForce(tempList, minimum, middle -1);
			}
